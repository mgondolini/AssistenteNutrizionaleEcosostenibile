<template>
  <div class="productInfo">
    ...
    <div>
      <img v-if=status v-bind:src="imgPath" />
    </div>
    <div>
    <!-- NUTRITION TABLE -->
    <!-- TODO - MUST be factorized -->
      <section v-if=status class="performance-facts">
        ...
        <p class="small-info">* Percent Daily Values are based on a 2,000 calorie diet.
